...
func (uq *UserQuery) QueryAssignments() *TaskAssignmentQuery {
...
func (uq *UserQuery) WithAssignments(opts ...func(*TaskAssignmentQuery)) *UserQuery {
	query := (&TaskAssignmentClient{config: uq.config}).Query()
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withAssignments; query != nil {
		if err := uq.loadAssignments(ctx, query, nodes,
			func(n *User) { n.Edges.Assignments = []*TaskAssignment{} },
			func(n *User, e *TaskAssignment) { n.Edges.Assignments = append(n.Edges.Assignments, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadAssignments(ctx context.Context, query *TaskAssignmentQuery, nodes []*User, init func(*User), assign func(*User, *TaskAssignment)) error {
